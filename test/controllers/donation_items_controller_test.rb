...
class DonationItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation_item" do
    assert_difference('DonationItem.count') do
      post donation_items_url, params: { donation_item: { image_url: @donation_item.image_url, name: @donation_item.name, price: @donation_item.price, price: @donation_item.price } }
    end
  ...
  test "should update donation_item" do
    patch donation_item_url(@donation_item), params: { donation_item: { image_url: @donation_item.image_url, name: @donation_item.name, price: @donation_item.price, price: @donation_item.price } }
